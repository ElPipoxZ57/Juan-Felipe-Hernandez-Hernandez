...
import mx.utng.s26.sesion26.model.service.IUserService;
...
public class UserControler {
    ...
    public String list(Model model){
        model.addAttribute("Title", "Listado de Docente");
    ...
    public String create (Model model){
        model.addAttribute("title", "Formulario de Registrar Docente");
